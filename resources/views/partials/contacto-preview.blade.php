<div class="space-y-6">
    ...
    <div>
        <p class="text-xs font-semibold uppercase tracking-[0.2em] text-amber-400">Soporte & Comunidad</p>
        <h2 class="text-2xl font-bold text-zinc-900 dark:text-white">// CANALES DE CONTACTO</h2>
    </div>
        ...
        <a href="https://discord.gg" target="_blank" rel="noopener noreferrer"
           class="group flex flex-col justify-between rounded-xl border border-zinc-200 bg-white p-6 transition hover:border-amber-400 dark:border-zinc-700 dark:bg-zinc-900">
            <div>
                ...
                <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Lobby principal para encontrar equipo y hablar con moderadores.</p>
            </div>
            <div class="mt-4">
        ...
        <a href="https://twitch.tv" target="_blank" rel="noopener noreferrer"
           class="group flex flex-col justify-between rounded-xl border border-zinc-200 bg-white p-6 transition hover:border-amber-400 dark:border-zinc-700 dark:bg-zinc-900">
            <div>
                ...
                <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Transmisiones en vivo de los torneos oficial de la comunidad.</p>
            </div>
            <div class="mt-4">
                <span class="inline-block rounded-md bg-amber-400/10 px-2.5 py-1 font-mono text-xs font-medium text-amber-600 dark:text-amber-400">
        ...
        <a href="https://twitter.com" target="_blank" rel="noopener noreferrer"
           class="group flex flex-col justify-between rounded-xl border border-zinc-200 bg-white p-6 transition hover:border-amber-400 dark:border-zinc-700 dark:bg-zinc-900">
            <div>
                ...
                <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Anuncios de parches, torneos y noticias de última hora.</p>
            </div>
            <div class="mt-4">
                <span class="inline-block rounded-md bg-amber-400/10 px-2.5 py-1 font-mono text-xs font-medium text-amber-600 dark:text-amber-400">
                    @NexusGamerGG
        ...
        <a href="https://instagram.com" target="_blank" rel="noopener noreferrer"
           class="group flex flex-col justify-between rounded-xl border border-zinc-200 bg-white p-6 transition hover:border-amber-400 dark:border-zinc-700 dark:bg-zinc-900">
            <div>
                ...
                <p class="mt-2 text-sm text-zinc-500 dark:text-zinc-400">Los mejores clips, jugadas destacadas y contenido corto.</p>
            </div>
            <div class="mt-4">
                <span class="inline-block rounded-md bg-amber-400/10 px-2.5 py-1 font-mono text-xs font-medium text-amber-600 dark:text-amber-400">
                    @nexusgamer.zone
